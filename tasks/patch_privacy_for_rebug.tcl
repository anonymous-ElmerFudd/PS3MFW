...
namespace eval ::patch_privacy_for_rebug {

    array set ::patch_privacy_for_rebug::options {
        --patch-allmusic true
    ...
    proc main { } {
        ...
        if {$::patch_privacy_for_rebug::options(--patch-allmusic)} {
            set selfs {x3_amgsdk.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_allmusic_com_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-bitwallet)} {
            set selfs {edy_plugin.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_bitwallet_co_jp_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-intertrust)} {
            set selfs {mcore.self msmw2.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_intertrust_com_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-marlin-drm)} {
            set selfs {mcore.self}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_marlin-drm_com_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-marlin-tmo)} {
            set selfs {mcore.self msmw2.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_marlin-tmo_com_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-oasis-open)} {
            set selfs {mcore.self msmw2.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_oasis-open_org_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-octopus-drm)} {
            set selfs {mcore.self msmw2.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_octopus-drm_com_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-playstation-com)} {
            set selfs {netconf_plugin.sprx sysconf_plugin.sprx sysconf_plugin.sprx.dex}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_playstation_com_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-playstation-net)} {
        set selfs {libad_core.sprx libmedi.sprx libsysutil_np_clans.sprx libsysutil_np_commerce2.sprx libsysutil_np_util.sprx}
            ::modify_devflash_files [file join dev_flash sys external] $selfs ::patch_privacy_for_rebug::patch_playstation_net_self
        ...
        set selfs {autodownload_plugin.sprx download_plugin.sprx esehttp.sprx eula_cddb_plugin.sprx eula_hcopy_plugin.sprx eula_net_plugin.sprx explore_category_friend.sprx explore_category_game.sprx explore_category_music.sprx explore_category_network.sprx explore_category_photo.sprx explore_category_psn.sprx explore_category_sysconf.sprx explore_category_tv.sprx explore_category_user.sprx explore_category_video.sprx explore_plugin.sprx explore_plugin_ft.sprx explore_plugin_np.sprx friendtrophy_plugin.sprx game_ext_plugin.sprx hknw_plugin.sprx nas_plugin.sprx newstore_plugin.sprx np_eula_plugin.sprx np_trophy_plugin.sprx np_trophy_util.sprx photo_network_sharing_plugin.sprx profile_plugin.sprx regcam_plugin.sprx sysconf_plugin.sprx sysconf_plugin.sprx.dex videoeditor_plugin.sprx videoplayer_plugin.sprx videoplayer_util.sprx vsh.self vsh.self.swp vsh.self.cexsp x3_mdimp11.sprx x3_mdimp7.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_playstation_net_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-playstation-org)} {
            set selfs {netconf_plugin.sprx sysconf_plugin.sprx sysconf_plugin.sprx.dex}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_playstation_org_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-qriocity)} {
            set selfs {regcam_plugin.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_qriocity_com_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-sony)} {
            set selfs {eula_net_plugin.sprx mintx_client.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_sony_com_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-sony)} {
            set selfs {videodownloader_plugin.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_sony_co_jp_self
        }
        if {$::patch_privacy_for_rebug::options(--patch-trendmicro)} {
            set selfs {silk.sprx silk_nas.sprx}
            ::modify_devflash_files [file join dev_flash vsh module] $selfs ::patch_privacy_for_rebug::patch_trendmicro_com_self
        }
    }

    proc patch_allmusic_com_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_allmusic_com_elf
    }
    proc patch_bitwallet_co_jp_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_bitwallet_co_jp_elf
    }
    proc patch_intertrust_com_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_intertrust_com_elf
    }
    proc patch_marlin-drm_com_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_marlin-drm_com_elf
    }
    proc patch_marlin-tmo_com_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_marlin-tmo_com_elf
    }
    proc patch_oasis-open_org_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_oasis-open_org_elf
    }
    proc patch_octopus-drm_com_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_octopus-drm_com_elf
    }
    proc patch_playstation_com_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_playstation_com_elf
    }
    proc patch_playstation_net_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_playstation_net_elf
    }
    proc patch_playstation_org_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_playstation_org_elf
    }
    proc patch_qriocity_com_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_qriocity_com_elf
    }
    proc patch_sony_com_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_sony_com_elf
    }
    proc patch_sony_co_jp_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_sony_co_jp_elf
    }
    proc patch_trendmicro_com_self {self} {
        ::modify_self_file $self ::patch_privacy_for_rebug::patch_trendmicro_com_elf
    }
